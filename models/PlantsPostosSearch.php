...
/**
 * PlantsPostosSearch represents the model behind the search form of `app\models\PlantsPostos`.
 */
class PlantsPostosSearch extends PlantsPostos
{
    /**
     * {@inheritdoc}
     */
